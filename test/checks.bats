...
@test "is_domain_format_valid success" {
     run is_domain_format_valid 'lokahost.online' "key"
    assert_success
}
...
@test "is_domain_format_valid lokahost.online." {
     run is_domain_format_valid 'mx.lokahost.online.' "key"
    assert_success
}
...
@test "is_dns_record_format_valid" {
    rtype='MX'
    priority=1;
    run is_dns_record_format_valid 'mx.lokahost.online.'
    assert_success
}
...
@test "is_alias_format_valid success" {
     run is_alias_format_valid 'lokahost.online' "key"
    assert_success
}

@test "is_alias_format_valid success www.domain.com" {
     run is_alias_format_valid 'www.lokahost.online' "key"
    assert_success
}
@test "is_alias_format_valid success lokahost.online,www.lokahost.online" {
     run is_alias_format_valid 'lokahost.online,www.lokahost.online' "key"
    assert_success
}

@test "is_alias_format_valid success *.lokahost.online" {
     run is_alias_format_valid '*.lokahost.online' "key"
    assert_success
}

@test "is_alias_format_valid success www.lokahost.online,*.lokahost.online" {
     run is_alias_format_valid 'www.lokahost.online,*.lokahost.online' "key"
    assert_success
}
