# Install Ioncube on Lokahostcp

By [Jaap Marcus](https://github.com/jaapmarcus/)  
[Source code](https://github.com/jaapmarcus/ioncube-lokahostcp-installer)
...
```bash
wget https://raw.githubusercontent.com/jaapmarcus/ioncube-lokahostcp-installer/main/install_ioncube.sh
