...
- **default-nomail**: Standard DNS template. Suitable for most usecases when you don’t want to host mail on Lokahostcp.
...
This date is not used by Lokahostcp, but can be used as a reminder.
