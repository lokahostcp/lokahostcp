		...
		<?php require $_SERVER["LOKAHOST"] . "/web/templates/includes/app-footer.php"; ?>
...
<?php } ?>
	...
	<?php require $_SERVER["LOKAHOST"] . "/web/templates/includes/jump-to-top-link.php"; ?>

	<?php if ($_SESSION["DEBUG_MODE"] == "true") {
		require $_SERVER["LOKAHOST"] . "/web/templates/pages/debug_panel.php";
	} ?>
