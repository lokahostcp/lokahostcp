	...
	>
		...
		<div class="form-container">
			...
			<div id="password-details" class="u-mb20">
				<?php require $_SERVER["LOKAHOSTCP"] . "/web/templates/includes/password-requirements.php"; ?>
			...
			<?php if ($_SESSION['userContext'] === 'admin') { ?>
				...
				<div x-cloak x-show="showAdvanced">
					...
					<?php if ((isset($_SESSION['DNS_SYSTEM'])) && (!empty($_SESSION['DNS_SYSTEM']))) { ?>
						...
						<?php require $_SERVER["LOKAHOSTCP"] . "/web/templates/includes/extra-ns-fields.php"; ?>
