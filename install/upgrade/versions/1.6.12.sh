...
# Lokahost Control Panel upgrade script for target version 1.6.12
...
# Fixed firewall loading failed after reboot, applying update to lokahost-iptables Systemd unit.
